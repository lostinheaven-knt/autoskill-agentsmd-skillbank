...
## Purpose
To help users create, schedule, and optimize social media content for platforms like LinkedIn, Twitter/X, Instagram, TikTok, and Facebook, focusing on engagement, audience growth, and business goals.

## When to use
- When the user requests help with creating social media posts, threads, or content calendars.
- When the user mentions terms like 'LinkedIn post', 'Twitter thread', 'social media strategy', or 'content scheduling'.
- When the user needs guidance on platform-specific best practices or content repurposing.

## When NOT to use
- When the user asks for technical support with social media platforms or account management.
- When the request is for creating paid advertising campaigns or detailed analytics beyond basic optimization tips.

## Inputs / Preconditions
- Required info: The target social media platform(s) and the user's content goals (e.g., brand awareness, leads).
- Assumptions: The user has access to the social media accounts and basic content creation tools.
- Constraints: Content must adhere to platform-specific guidelines and the user's brand voice.

## Procedure

1. Gather context by asking the user about their goals, target audience, brand voice, and available resources.
2. Select appropriate platform strategies and content formats based on the user's inputs and platform best practices.
3. Develop content using provided templates (e.g., LinkedIn story posts, Twitter threads) and hook formulas to maximize engagement.
4. Recommend a content calendar structure and scheduling approach, including repurposing workflows if applicable.
5. Provide engagement strategies and optimization tips based on analytics and platform algorithms.

## Checks
- Verify that the content aligns with the user's stated goals and brand voice before finalizing.
- Ensure platform-specific format guidelines are followed, such as character limits for Twitter or vertical video for TikTok.
## Failure modes
- Content fails to engage due to mismatched audience targeting or poor hook execution; detect by low interaction rates in analytics.
- Scheduling conflicts or irrelevant posting times reduce reach; detect by monitoring platform-specific performance data.

## Examples
- Example 1: A user wants to create a LinkedIn post for thought leadership. Use the 'Story Post' template with a curiosity hook, focus on business lessons, and avoid links in the post body.
- Example 2: A user needs a Twitter thread to teach a skill. Use the 'Tutorial Thread' template, keep tweets concise, and include visuals to increase engagement.

## Version / Changelog
v0.1.0: Imported from original draft with concrete content based on platform strategies, templates, and procedures.

<!-- ORIGINAL_DRAFT_PRESERVED:START -->
## Appendix: Original draft (verbatim)
